...
public class SerializableUtil {
  ...
  public static void serializeObject(Configuration conf,
      String objectPropertyName, Object object) throws IOException {
  ...
  public static <T> T deserializeObject(Configuration conf,
